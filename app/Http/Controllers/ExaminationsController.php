...
class ExaminationsController extends Controller
{
    public function exam_list()
    {
        ...
        return view('backend.admin.examinations.exam.list', $data);
    }

    public function exam_add()
    {
        $data['header_title'] = "Add Exam";
        return view('backend.admin.examinations.exam.add', $data);
    }
    ...
    public function exam_insert(Request $request)
    {
        ...
        $exam->save();
        return redirect('backend/admin/examinations/exam/list')->with('success', 'Exam Successfully Created!');
    }
    ...
    public function exam_edit($id)
    {
        ...
        if(!empty($data['getRecord']))
        {
            ...
            return view('backend.admin.examinations.exam.edit', $data);
        }
        else
        {
            abort(404);
    ...
    public function exam_update(Request $request, $id)
    {
        ...
        $exam->note = trim($request->note);
        $exam->save();
        return redirect('backend/admin/examinations/exam/list')->with('success', 'Exam Successfully Updated!');
    }
...
// marks register
    public function marks_register(Request $request)
    {
        ...
        return view('backend.admin.examinations.marks_register', $data);
    }

    // marks register teacher
    public function marks_register_teacher(Request $request)
    {
        ...
        $data['header_title'] = "Marks Register";
        return view('backend.teacher.marks_register', $data);
    }
    ...
    public function marks_grade_insert(Request $request)
    {
        ...
        $mark->save();
        return redirect('backend/admin/examinations/marks_grade/list')->with('success','Marks Grade Successfully Added.');
    }
    ...
    public function marks_grade_update($id, Request $request)
    {
        ...
        $mark->created_by = Auth::user()->id;
        $mark->save();
        return redirect('backend/admin/examinations/marks_grade/list')->with('success','Marks Grade Successfully Updated.');
    }
    public function marks_grade_delete($id)
    {
        $mark = MarksGradeModel::getSingle($id);
        $mark->delete();
        return redirect('backend/admin/examinations/marks_grade/list')->with('success','Marks Grade Successfully Deleted.');
    }
    ...
    public function MyExamTimetable(Request $request)
    {
        ...
        return view('backend.student.my_exam_timetable', $data);
    }
    public function submit_marks_register(Request $request)
    {
        ...
        {
            $json['message'] = 'Mark Register Successfully Saved. Some subject mark is greater than full mark.';
        }
    ...
    public function MyExamTimetableTeacher()
    {
        ...
        $data['header_title'] = "My Exam Timetable";
        return view('backend.teacher.my_exam_timetable', $data);
    }
    ...
    public function ParentMyExamTimetable($student_id)
    {
        ...
        return view('backend.parent.exam_timetable', $data);
    }
    ...
    public function myExamResult()
    {
        ...
        return view('backend.student.my_exam_result', $data);
    }
    ...
    public function ParentMyExamResult($student_id)
    {
        ...
        return view('backend.parent.my_exam_result', $data);
    }
