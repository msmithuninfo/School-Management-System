...
<link rel="stylesheet" href="{{ url('assets/emoji/emojionearea.min.css') }}">
<style type="text/css">
...
@endsection
@section('script')
    <script src="{{ url('assets/emoji/emojionearea.min.js') }}"></script>
    <script type="text/javascript">
        ...
        function scrolldown()
        {
            $('.chat').animate({scrollTop: $('.chat').prop('scrollHeight')+99999}, 111);
            $('.chat-history').animate({scrollTop: $('.chat-history').prop('scrollHeight')+99999}, 111);
        }
        scrolldown();
