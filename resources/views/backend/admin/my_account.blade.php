              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" value="{{ old('occupation', $getRecord->occupation) }}" name="occupation" class="form-control" placeholder="Blood Group">
                      <div style="color: red;">{{ $errors->first('blood_group') }}</div>

                  </div>
                  <div class="form-group col-md-6">
                    <label>Address</label>
                    <input type="text" value="{{ old('address', $getRecord->address) }}" name="address" class="form-control" placeholder="Blood Group">
                    <div style="color: red;">{{ $errors->first('blood_group') }}</div>
