                        ...
                        <div class="card-body">
                          ...
                          <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <input type="text" value="{{ $getRecord->title }}" class="form-control" name="title" placeholder="Title" required>
                              </div>
                              
                              <div class="form-group">
                                <label>Notice Date</label>
                                <input type="date" value="{{ $getRecord->notice_date }}" class="form-control" name="notice_date" required>
                              </div>
