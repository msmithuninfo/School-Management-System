              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" value="{{ old('admission_number') }}" name="admission_number" required class="form-control" placeholder="Admission Number">
                        <div style="color: red;">{{ $errors->first('admission_number') }}</div>
                    </div>

                    <div class="form-group col-md-6">
                        <label>Roll Number</label>
                        <input type="text" value="{{ old('roll_number') }}" name="roll_number" class="form-control" placeholder="Roll Number">
                    ...
                    <div class="form-group col-md-6">
                        <label>Caste</label>
                        <input type="text" value="{{ old('caste') }}" name="caste" class="form-control" placeholder="Caste">
                        <div style="color: red;">{{ $errors->first('caste') }}</div>

                    </div>
                    <div class="form-group col-md-6">
                        <label>Religion</label>
                        <input type="text" value="{{ old('religion') }}" name="religion" class="form-control" placeholder="Religion">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" value="{{ old('admission_date') }}" required name="admission_date" class="form-control" placeholder="Admission Date">
