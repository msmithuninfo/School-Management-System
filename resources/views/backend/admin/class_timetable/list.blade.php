                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('backend/admin/class_timetable/list') }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
              ...
              <form action="{{ url('backend/admin/class_timetable/add') }}" method="post">
                @csrf
                {{-- {{ csrf_token() }} --}}
