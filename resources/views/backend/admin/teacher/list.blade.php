      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('backend/admin/teacher/add') }}" class="btn btn-primary">Add New Teacher</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <a href="{{ url('backend/admin/teacher/list') }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
                    ...
                    <div class="card-body table-responsive p-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ url('backend/admin/teacher/edit/'.$value->id) }}" class="btn btn-info">
                                <i class="fas fa-edit"></i>
                              </a>
                              <a href="{{ url('backend/admin/teacher/delete/'.$value->id) }}" class="btn btn-danger">
