            ...
            <form action="" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('percent_from') }}" name="percent_from" required class="form-control">
                </div>
                <div class="form-group">
                    <label>Percent To</label>
                    <input type="number" value="{{ old('percent_to') }}" name="percent_to" required class="form-control">
                </div>
