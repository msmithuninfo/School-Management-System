                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <a href="{{ url('backend/parent/my_student/homework/'.$getStudent->id) }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                          </div>
                        </div>
                      </div>
                    </form>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">My Student Homework List</h3>
                            </div>
