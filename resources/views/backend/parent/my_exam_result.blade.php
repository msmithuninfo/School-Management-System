  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>My Student Exam Result <span style="color: blue;">({{ $getStudent->name }} {{ $getStudent->last_name }})</span></h1>
        </div>
      </div>
    </div>
  </section>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ url('backend/parent/my_exam_result/print?exam_id='.$value['exam_id'].'&student_id='.$getStudent->id) }}" target="_blank" class="btn-sm float-right btn btn-primary">Print</a>
                    </div>
