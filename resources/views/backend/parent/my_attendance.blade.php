  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>My Attendance <span style="color: blue;">({{ $getStudent->name }} {{ $getStudent->last_name }})({{ $getRecord->total() }})</span></h1>
        </div>
      </div>
    </div>
  </section>
              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-2">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('backend/parent/my_student/attendance/'.$getStudent->id) }}" class="btn btn-success" style="margin-top: 30px;">Reset</a>
                  </div>
                </div>
              </div>
            </form>
